                                ...
                                <table id="listTareas" class="table table-striped table-sm" cellspacing="0"
                                    ...
                                    <c:forEach var="tarea" items="${tareas}" varStatus="status">
                                        <tr>
                                            ...
                                            <td>${tarea.estado == 1 ? 'Pendiente' : tarea.estado == 2 ? 'En Proceso': 'Finalizada'}</td>
                                            <td>
                                                <a href="${pageContext.request.contextPath}/tareas?accion=obtenerTarea&id=${tarea.idTarea}"
                                                   class="btn btn-info btn-sm">Editar</a>
                                                <a href="${pageContext.request.contextPath}/tareas?accion=eliminar&id=${tarea.idTarea}"
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="form-tarea" action="${pageContext.request.contextPath}/tareas" method="POST">
        ...
        <div class="row d-flex justify-content-center">
            <div class="col-xl-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form id="form-tarea" action="${pageContext.request.contextPath}/tareas?accion=editar" method="POST">
                                <%@include file="formTarea.jsp" %>
                    </div>
                    <div class="card-footer">
                        <button type="submit" class="btn btn-primary btn-block" form="form-tarea">Guardar cambios
                        </button>
                        <a href="${pageContext.request.contextPath}/tareas?accion=listar" class="btn btn-danger btn-block">Cancelar</a>
                    </div>
                </div>
            </div>
        </div>
